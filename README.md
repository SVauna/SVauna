...
Tecnologia aplicada a negócios • Organização de processos • Soluções digitais
...
Sou estudante de **Análise e Desenvolvimento de Sistemas** na **Universidade Presbiteriana Mackenzie**, com interesse em tecnologia aplicada a negócios, organização de processos e desenvolvimento de soluções digitais.

Tenho interesse em compreender problemas reais e transformá-los em soluções bem estruturadas, priorizando clareza, eficiência e aprendizado prático.

Atualmente, busco desenvolver minha base técnica e analítica por meio de projetos acadêmicos e práticos que conectem tecnologia, processos e necessidades reais de usuários e organizações.
...
Busco crescer na área de tecnologia, desenvolvendo soluções que unam **organização, clareza, eficiência e impacto prático**.

Tenho interesse em participar de projetos que me permitam aplicar conhecimentos técnicos, colaborar com equipes e contribuir para a criação de sistemas úteis, bem planejados e alinhados às necessidades reais do negócio.
